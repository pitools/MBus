...
namespace MBTools.Data.Repository
{
    ...
    public class UnitOfWork<TContext> : IRepoFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        public IRepo<TEntity> GetRepository<TEntity>(bool hasCustomRepository = false) where TEntity : class
        {
            ...
            {
                var customRepo = _context.GetService<IRepo<TEntity>>();
                if (customRepo != null)
                {
                    return customRepo;
                }
            ...
            {
                repositories[type] = new Repo<TEntity>(_context);
            }

            return (IRepo<TEntity>)repositories[type];
        }
